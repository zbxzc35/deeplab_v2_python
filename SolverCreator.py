...
def create_solver(proto_path, train_net, snapshot_prefix, display=20, snapshot=20000, power=0.9, base_lr=1e-2, momentum=0.9, weight_decay=0.0001, max_iter=20000):
