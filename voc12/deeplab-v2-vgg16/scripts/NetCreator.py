...
def aspp_unit(bottom, nout, ks=1):
...
"""
    ...
    data_root: folder path for training images, e.g. "/data1/wuhuikai/DT_GAN/benchmark/cityscapes"
    source: file path for file containing a list of training images,
            e.g. "list/train.txt"
    num_labels: class count to segment
    batch_size: training batch size
"""
def deeplab_vgg16(proto_path, train, data_root, source, num_labels, batch_size=10, crop_size=321):
    # Data Layer
    n = caffe.NetSpec()
    ...
    if train:
        n.data, n.label, n.data_dim = L.ImageSegData(
            ...
            image_data_param=dict(
                ...
                shuffle=True,
                label_type=P.ImageData.PIXEL
            )
        )
    else:
        n.data, n.label = L.MemoryData(
            ntop=2,
            batch_size=batch_size, 
            channels=3, 
            height=crop_size, 
    ...
    # fc 8
    n.fc8_1 = aspp_unit(n.drop7_1, num_labels)
    ...
    # fc 8
    n.fc8_2 = aspp_unit(n.drop7_2, num_labels)
    ...
    # fc 8
    n.fc8_3 = aspp_unit(n.drop7_3, num_labels)
    ...
    # fc 8
    n.fc8_4 = aspp_unit(n.drop7_4, num_labels)
